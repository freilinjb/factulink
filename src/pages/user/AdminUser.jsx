...
const AdminUser = () => {
    ...
    const {  getUsersPage, usuarios  } = userContext;
    const {  getCustomerPage } = customerContext;
    ...
    return ( 
        ...
        <div className="btn-toolbar mb-2 mb-md-0">
          <ButtonGroup>
            ...
            <Button variant="outline-primary" size="sm"><Link to={'/user/add'}>+ New User</Link></Button>
          </ButtonGroup>
        </div>
      </div>
      ...
      <TableUser limit={limit} page={page} setPage={setPage} search={search}/>
      </>
     );
}
