...
import TableReporteCuentaPorPagar from "../../components/table/TableReporteCuentaPorPagar";
...
const CuentaPorPagar = () => {
  ...
  const consultarDatos = async (limit, page, cliente = 0, tipoFactura = 0, desde = '', hasta = '') => {
    ...
    await clienteAxios
    .get(`/api/cuentaPorPagar/?page=${page > 0 ? page : 1}&limit=${limit} ${cliente > 0 ? '&cliente=' + cliente : ''}${tipoFactura > 0 ? '&tipoFactura=' + tipoFactura : ''} 
    ...
    <>
        ...
        <div className="d-block mb-4 mb-xl-0">
          ...
          >
            ...
            <Breadcrumb.Item active> Reportes de Cuentas Por Pagar </Breadcrumb.Item>
          </Breadcrumb>
        </div>
      </div>
      ...
      <TableReporteCuentaPorPagar limit={limit} page={page} setPage={setPage} search={search} compras={compras} total_page={total_page} consultarDatos={consultarDatos}/>
