...
const AdminCustomer = () => {
    ...
    const {  clientes, getCustomerPage } = customerContext;
    ...
    return ( 
        ...
        <div className="d-block mb-4 mb-xl-0">
          ...
          >
            ...
            <Breadcrumb.Item active> Admin Customer </Breadcrumb.Item>
          </Breadcrumb>
        ...
        <div className="btn-toolbar mb-2 mb-md-0">
          <ButtonGroup>
            ...
            <Button variant="outline-primary" size="sm"><Link to={'/customer/add'}>+ New Customer</Link></Button>
          </ButtonGroup>
        </div>
      </div>
