...
export const ChoosePhotoWidget = (props) => {
  const { title, photo, onChangePicture } = props;
          ...
          <div className="file-field">
            <div className="d-flex justify-content-xl-center ms-xl-3">
              <div className="d-flex">
                ...
                <input type="file" name="imagen" id="imagen" onChange={onChangePicture} />
      ...
      <Card.Body>
        <Row className="d-block d-xl-flex align-items-center">
          ...
          <Col xs={12} xl={7} className="px-xl-0">
            ...
            <small>{period}, <FontAwesomeIcon icon={faGlobeEurope} size="xs" /> Actual</small>
            <div className="small mt-2">
              <FontAwesomeIcon icon={percentageIcon} className={`${percentageColor} me-1`} />
              <span className={`${percentageColor} fw-bold`}>
                {percentage}%
              </span> Comparacion del mes anterior
            </div>
          </Col>
        </Row>
      </Card.Body>
