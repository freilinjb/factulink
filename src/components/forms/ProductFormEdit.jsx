...
const ProductFormEdit = ({id}) => {
  ...
  const { updateProduct, getProductByID, productoEditar, getCategory, getBrand, getSubCategory, getUnidPresentation, marcas, categorias, subCategorias, unidadPresentacion, estado, mensaje} = productContext;
    ...
    if(productoEditar.idProducto > 0 ) {
      ...
      setCampos({
        ...campos,
                    ...
                    marca: {value: productoEditar.idMarca, label: productoEditar.marca},
                    categoria: {value: productoEditar.idCategoria, label: productoEditar.categoria},
                    subCategoria: {value: productoEditar.idSubCategoria, label: productoEditar.subcategoria},
                    unidad: {value: productoEditar.idUnidad, label: productoEditar.unidad},
                    estado: {value: productoEditar.idEstado, label: productoEditar.estado},
                    reorden: productoEditar.reorden,
                    stockInicial: productoEditar.stockInicial,
                    ...
                    incluyeItbis: (productoEditar.incluyeItbis == "activo") ? true : false,
                    proveedor: productoEditar.proveedores,
                    observacion: productoEditar.observacion,
      });
    }
                  ...
                  <Col sm={12} xs={12} lg={6} md={12}>
                    <Col md={12}>
                      <ChoosePhotoWidget
                        ...
                        photo={imgData ? imgData :( productoEditar.urlFoto ? productoEditar.urlFoto : Profile3)}
